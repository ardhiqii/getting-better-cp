...
[View on USACO](https://usaco.org/index.php?page=viewproblem2&cpid=761)
...
The first line of input contains $N$, the number of measurements Farmer John makes. Each of the next $N$ lines contains one measurement, in the format above, specifying a day (an integer in the range $1 \ldots 100$), the name of a cow, and the change in her milk output since it was last measured (a nonzero integer). Each cow's milk output will always be in the range $0 \ldots 1000$.

## Output Format

Please output the number of days (an integer in the range $0 \ldots 100$) on which Farmer John needs to adjust his motivational display.
